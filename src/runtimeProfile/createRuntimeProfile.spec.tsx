...
describe('CreateRuntimeProfile Component & Service', () => {
  ...
  it('should format runtime environment config according to IRuntimeEnvironmentConfig interface', () => {
    ...
    expect(formatRuntimeEnvironmentProperties(undefined)).toEqual([]);
  });

  it('should format executor and driver configuration according to IExecutorAndDriverConfig interface', () => {
