...
from dataproc_jupyter_plugin.commons.constants import (
    CLOUDKMS_SERVICE_NAME, CLOUDRESOURCEMANAGER_SERVICE_NAME,
    COMPUTE_SERVICE_DEFAULT_URL, COMPUTE_SERVICE_NAME,
    DATACATALOG_SERVICE_NAME, DATAPROC_SERVICE_NAME, METASTORE_SERVICE_NAME,
    STORAGE_SERVICE_DEFAULT_URL, STORAGE_SERVICE_NAME)
