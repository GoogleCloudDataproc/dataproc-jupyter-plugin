        ...
        try:
            ...
            async with self.client_session.get(
                ...
                if response.status == 200:
                    ...
                    return {"error": f"Failed to fetch clusters: {response.status} {await response.text()}"}
        ...
        try:
            ...
            async with self.client_session.get(
                ...
                if response.status == 200:
                    ...
                    return {"error": f"Failed to fetch runtimes: {response.status} {await response.text()}"}
        except Exception as e:
